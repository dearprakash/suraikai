...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;var toc_default=`button#toc {
  background-color: transparent;
  border: none;
  text-align: left;
  cursor: pointer;
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;import{Fragment as Fragment6,jsx as jsx24,jsxs as jsxs13}from"preact/jsx-runtime";var Backlinks=__name(({fileData,allFiles,displayClass,cfg})=>{if(fileData.slug==="index")return jsx24(Fragment6,{});let slug=simplifySlug(fileData.slug),backlinkFiles=allFiles.filter(file=>file.links?.includes(slug));return jsxs13("div",{class:classNames(displayClass,"backlinks"),children:[jsx24("h3",{children:i18n(cfg.locale).components.backlinks.title}),jsx24("ul",{class:"overflow",children:backlinkFiles.length>0?backlinkFiles.map(f=>jsx24("li",{children:jsx24("a",{href:resolveRelative(fileData.slug,f.slug),class:"internal",children:f.frontmatter?.title})})):jsx24("li",{children:i18n(cfg.locale).components.backlinks.noBacklinksFound})})]})},"Backlinks");Backlinks.css=backlinks_default;var Backlinks_default=__name(()=>Backlinks,"default");var search_default=`.search {
...
.callout[data-callout=gatekeeper] {
  --color: #000;
  --border: #a2a9b1;
  --bg: #222;
  width: 300px;
...
.callout[data-callout=gatekeeper] .callout-icon {
  display: none;
}
.callout[data-callout=gatekeeper] .callout-title {
  font-size: 16px;
  font-weight: bold;
...
.callout[data-callout=gatekeeper] .callout-content {
  padding: 5px 0;
}
.callout[data-callout=gatekeeper] .callout-content h3 {
  font-size: 14px;
  margin: 5px 0;
}
.callout[data-callout=gatekeeper] .callout-content p {
  margin: 5px 0;
}
.callout[data-callout=gatekeeper] .callout-image {
  text-align: center;
  margin: 10px 0;
}
.callout[data-callout=gatekeeper] .callout-image img {
  max-width: 100%;
  height: auto;
  border: 1px solid var(--border);
}
@media (max-width: 600px) {
  .callout {
    /* Ensure the callout title and content are full width */
  }
  .callout[data-callout=gatekeeper] {
    float: none;
    width: 100%;
...
.callout[data-callout=artifactmod] {
  --color: #000;
  --border: #c4ed0c;
  --bg: #222;
  width: 300px;
...
.callout[data-callout=artifactmod] .callout-icon {
  display: none;
}
.callout[data-callout=artifactmod] .callout-title {
  font-size: 26px;
  font-weight: bold;
...
.callout[data-callout=artifactmod] .callout-content {
  padding: 5px 0;
}
.callout[data-callout=artifactmod] .callout-content h3 {
  font-size: 14px;
  margin: 5px 0;
}
.callout[data-callout=artifactmod] .callout-content p {
  margin: 5px 0;
}
.callout[data-callout=artifactmod] .callout-image {
  text-align: center;
  margin: 10px 0;
}
.callout[data-callout=artifactmod] .callout-image img {
  max-width: 100%;
  height: auto;
  border: 1px solid var(--border);
}
...
.callout[data-callout=artifactcursed] {
  --color: #000;
  --border: #e42a11;
  --bg: #222;
  width: 300px;
...
.callout[data-callout=artifactcursed] .callout-icon {
  display: none;
}
.callout[data-callout=artifactcursed] .callout-title {
  font-size: 16px;
  font-weight: bold;
...
.callout[data-callout=artifactcursed] .callout-content {
  padding: 5px 0;
}
.callout[data-callout=artifactcursed] .callout-content h3 {
  font-size: 14px;
  margin: 5px 0;
}
.callout[data-callout=artifactcursed] .callout-content p {
  margin: 5px 0;
}
.callout[data-callout=artifactcursed] .callout-image {
  text-align: center;
  margin: 10px 0;
}
.callout[data-callout=artifactcursed] .callout-image img {
  max-width: 100%;
  height: auto;
  border: 1px solid var(--border);
}
...
.callout[data-callout=artifactamulet] {
  --color: #000;
  --border: #fdfa32;
  --bg: #222;
  width: 300px;
...
.callout[data-callout=artifactamulet] .callout-icon {
  display: none;
}
.callout[data-callout=artifactamulet] .callout-title {
  font-size: 16px;
  font-weight: bold;
  background-color: #fdfa32;
  padding: 5px;
  border-bottom: 1px solid var(--border);
  text-align: center;
  margin: -10px -10px 10px -10px;
}
.callout[data-callout=artifactamulet] .callout-content {
  padding: 5px 0;
}
.callout[data-callout=artifactamulet] .callout-content h3 {
  font-size: 14px;
  margin: 5px 0;
}
.callout[data-callout=artifactamulet] .callout-content p {
  margin: 5px 0;
}
.callout[data-callout=artifactamulet] .callout-image {
  text-align: center;
  margin: 10px 0;
}
.callout[data-callout=artifactamulet] .callout-image img {
  max-width: 100%;
  height: auto;
  border: 1px solid var(--border);
}
...
.callout[data-callout=artifactroc] {
  --color: #000;
  --border: #32f6fd;
  --bg: #222;
  width: 300px;
...
.callout[data-callout=artifactroc] .callout-icon {
  display: none;
}
.callout[data-callout=artifactroc] .callout-title {
  font-size: 16px;
  font-weight: bold;
...
.callout[data-callout=artifactroc] .callout-content {
  padding: 5px 0;
}
.callout[data-callout=artifactroc] .callout-content h3 {
  font-size: 14px;
  margin: 5px 0;
}
.callout[data-callout=artifactroc] .callout-content p {
  margin: 5px 0;
}
.callout[data-callout=artifactroc] .callout-image {
  text-align: center;
  margin: 10px 0;
}
.callout[data-callout=artifactroc] .callout-image img {
  max-width: 100%;
  height: auto;
  border: 1px solid var(--border);
}
...
.callout[data-callout=artifactsc] {
  --color: #000;
  --border: #a332e4;
  --bg: #222;
  width: 300px;
...
.callout[data-callout=artifactsc] .callout-icon {
  display: none;
}
.callout[data-callout=artifactsc] .callout-title {
  font-size: 16px;
  font-weight: bold;
  background-color: #a332e4;
  padding: 5px;
  border-bottom: 1px solid var(--border);
  text-align: center;
  margin: -10px -10px 10px -10px;
}
.callout[data-callout=artifactsc] .callout-content {
  padding: 5px 0;
}
.callout[data-callout=artifactsc] .callout-content h3 {
  font-size: 14px;
  margin: 5px 0;
}
.callout[data-callout=artifactsc] .callout-content p {
  margin: 5px 0;
}
.callout[data-callout=artifactsc] .callout-image {
  text-align: center;
  margin: 10px 0;
}
.callout[data-callout=artifactsc] .callout-image img {
  max-width: 100%;
  height: auto;
  border: 1px solid var(--border);
}
...
.callout[data-callout=gatekeepers] {
  --callout-icon: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'><path fill='none' d='M0 0h24v24H0z'/><path d='M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z' fill='currentColor'/></svg>");
}

.callout[data-callout=spawned] {
  --color: #000;
  --border: #FFFFFF; /* White from [Spawned] text */
  --bg: #222;
  width: 300px;
  border: 1px solid var(--border);
  background-color: var(--bg);
...
.callout[data-callout=spawned] .callout-icon {
  display: none;
}
.callout[data-callout=spawned] .callout-title {
  font-size: 16px;
  font-weight: bold;
...
.callout[data-callout=spawned] .callout-content {
  padding: 5px 0;
}
.callout[data-callout=spawned] .callout-content h3 {
  font-size: 14px;
  margin: 5px 0;
}
.callout[data-callout=spawned] .callout-content p {
  margin: 5px 0;
}
.callout[data-callout=spawned] .callout-content img {
  max-width: 100%;
  height: auto;
  border: 1px solid var(--border);
}
...
.callout[data-callout=base] {
  --color: #000;
  --border: #00FFFF; /* Cyan from [Base] text */
  --bg: #222;
  width: 300px;
  border: 1px solid var(--border);
  background-color: var(--bg);
...
.callout[data-callout=base] .callout-icon {
  display: none;
}
.callout[data-callout=base] .callout-title {
  font-size: 16px;
  font-weight: bold;
...
.callout[data-callout=base] .callout-content {
  padding: 5px 0;
}
.callout[data-callout=base] .callout-content h3 {
  font-size: 14px;
  margin: 5px 0;
}
.callout[data-callout=base] .callout-content p {
  margin: 5px 0;
}
.callout[data-callout=base] .callout-content img {
  max-width: 100%;
  height: auto;
  border: 1px solid var(--border);
}
...
.callout[data-callout=rampant] {
  --color: #000;
  --border: #FFD700; /* Gold from [Rampant] text */
  --bg: #222;
  width: 300px;
  border: 1px solid var(--border);
  background-color: var(--bg);
...
.callout[data-callout=rampant] .callout-icon {
  display: none;
}
.callout[data-callout=rampant] .callout-title {
  font-size: 16px;
  font-weight: bold;
...
.callout[data-callout=rampant] .callout-content {
  padding: 5px 0;
}
.callout[data-callout=rampant] .callout-content h3 {
  font-size: 14px;
  margin: 5px 0;
}
.callout[data-callout=rampant] .callout-content p {
  margin: 5px 0;
}
.callout[data-callout=rampant] .callout-content img {
  max-width: 100%;
  height: auto;
  border: 1px solid var(--border);
}
...
.callout[data-callout=siren] {
  --color: #000;
  --border: #FF0000; /* Red from [Siren] text */
  --bg: #222;
  width: 300px;
  border: 1px solid var(--border);
  background-color: var(--bg);
...
.callout[data-callout=siren] .callout-icon {
  display: none;
}
.callout[data-callout=siren] .callout-title {
  font-size: 16px;
  font-weight: bold;
...
.callout[data-callout=siren] .callout-content {
  padding: 5px 0;
}
.callout[data-callout=siren] .callout-content h3 {
  font-size: 14px;
  margin: 5px 0;
}
.callout[data-callout=siren] .callout-content p {
  margin: 5px 0;
}
.callout[data-callout=siren] .callout-content img {
  max-width: 100%;
  height: auto;
  border: 1px solid var(--border);
}
...
/* Image Adjustment Snippet by ITS Themes for Obsidian */
body {
...
/*Left & Right*/
:not(.markdown-rendered) img:is([alt*=left], [alt*=locl]),
:not(.markdown-rendered) img[src*="#locl"] img,
...
:not(.markdown-rendered) img:is([alt*=right], [alt*=locr]),
:not(.markdown-rendered) img[src*="#locr"] img,
...
:not(.lp-img-float) .is-live-preview img:is([alt*=right], [alt*=locr]),
:not(.lp-img-float) .is-live-preview img:is([alt*=left], [alt*=locl]),
:not(.lp-img-float) .is-live-preview .image-embed:is([alt*=right], [alt*=locr]),
:not(.lp-img-float) .is-live-preview .image-embed:is([alt*=left], [alt*=locl]) {
  float: unset;
}
...
/* All Artifacts IMG Size in Table */
body[data-slug="Artifacts/AllArtifacts"] td img {
  max-width: 65% !important;
}

body[data-slug="Artifacts/AllArtifacts"] th img {
  max-width: 65% !important;
}

/* All Monsters IMG Size in Table */
body[data-slug="Monsters/AllMonsters"] td img {
  max-width: 65% !important;
}

body[data-slug="Monsters/AllMonsters"] th img {
  max-width: 65% !important;
}

/* All Monsters Page Styling */
[data-slug="Monsters/AllMonsters"] img {
  margin: 0;
}

[data-slug="Monsters/AllMonsters"] a.internal img {
  background-color: transparent;
}

[data-slug="Monsters/AllMonsters"] a.internal {
  background-color: transparent;
}

/* All Artifacts Page Styling */
[data-slug="Artifacts/AllArtifacts"] img {
  margin: 0;
}

[data-slug="Artifacts/AllArtifacts"] a.internal img {
  background-color: transparent;
}

[data-slug="Artifacts/AllArtifacts"] a.internal {
  background-color: transparent;
}
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;var popover_default=`@keyframes dropin {
  0% {
    opacity: 0;
    visibility: hidden;
  }
